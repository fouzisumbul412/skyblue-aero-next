...
const defaultLayout = {
  ...
  sections: [
    { 
      type: "INTRO", title: "Aviation Expertise, Delivered with Precision.", subtitle: "Our Story", 
      description: "SkyBlue Aero is an aviation services company owned by Captain Sylvester Vijay Moni, bringing over 15 years of industry experience...\n\nWith a trusted global network of professionals—including pilots, engineers, and operational teams—SkyBlue Aero works closely with aircraft owners and operators to deliver efficient, compliant, and well-coordinated aviation solutions.", 
      image: "", items: [] 
    },
    { 
      type: "GRID", title: "Uncompromising Reliability, Unparalleled Value", subtitle: "The Standard of Excellence", 
      items: [
        { icon: "Globe2", title: "Vision", description: "To emerge as a globally trusted aviation partner, known for excellence, reliability, and world-class service delivery across every touchpoint." },
        { icon: "Target", title: "Mission", description: "To provide exceptional aviation services that exceed client expectations, fostering long-term relationships built on trust, transparency, and mutual success." },
      ] 
    },
    { 
      type: "GRID", title: "The Principles That Guide Us", subtitle: "Our Values", 
      items: [
        { title: "Safety First", description: "Every decision, recommendation, and operation is evaluated through the lens of safety — no exceptions, no compromise." },
        { title: "Client Focus", description: "We work as an extension of your team, aligning every solution to your operational priorities and business objectives." },
        { title: "Integrity", description: "Transparent communication, honest advice, and ethical operations form the foundation of every client relationship." },
      ] 
    },
  ]
};
...
export default function AdminAboutPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (result.success) toast.success("About Page saved successfully!");
    ...
    <div className="p-6 max-w-[1400px] mx-auto space-y-8 pb-20">
      <div className="sticky top-0 z-20 bg-slate-50/90 backdrop-blur-md pb-4 pt-4 border-b border-slate-200 flex items-center justify-between shadow-sm -mx-6 px-6 mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Manage company history, vision, mission, and core values.</p>
        </div>
